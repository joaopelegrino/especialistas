# NIST SP 800-207: Zero Trust Architecture - Versão para Contextualização LLM
...
### 6.3 Acesso de Não-Funcionários
...
of the last PDP/PEP gateway. For example, consider the passenger screening mode an airport.
...
The Cloud Smart8 strategy, updated Data Center Optimization Initiative [M-19-19] poly, and
...
This publicatis available free of charge from: https://doi.org/10.6028/NIST.SP.800-207
...
[HWAM] Department of Homeland Security (2015) Hardware Assetanagement
...
Systems and Organizations: A System Life Cycle Approacfor Security
...
G2B Government to Buness (private industry)
...
ZTA strategies to pl and deploy an enterprise environment, there is no single solution that
...
These are the issues that ang adoption of a ZTA at present. These were classified as
...
osture over traditional network perimeter-based security. The tenets of ZTA aim to reduce the
...
in shrinking the attack surface of resources may become apparent. The metrics of succesof
...
[5] Weidman J, Grossklags J (2017) I Like It but I Hate Itployee Perceptions
