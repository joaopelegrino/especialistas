# DSM:TESTING:data_case_helper HEALTHCARE:test_database_support
defmodule HealthcareCMS.DataCase do
  ...
  during tests are reverted at the end of every test.
  If you are using PostgreSQL, you can even run database
  tests asynchronously by setting `use HealthcareCMS.DataCase,
