...
echo "   1. useradd -m -G wheel -s /bin/bash oseng"
echo "   2. passwd oseng" 
...
- **Sem dependências GUI:** Perfeito para ambiente WSL
...
"    que ajudam a identificar erros instantaneamente
...
"    feedback visual para confirmar entrada
...
colorscheme default
" 📖 TÓPICO: Esquema de cores confiável
...
" 💡 Exemplo prático: Assembly tem 10+ cores diferentes para instruções
...
" 🎯 Por que no OSR2: Código C/ASM mal indentado é ilegível e gera bugs.
...
" 💡 Exemplo prático: Após "if (condition) {" próxima linha indenta +4
...
" ⚡ Impacto: Edição de indentação funciona como tab nativo
...
" 🎯 Por que no OSR2: Você pode lembrar de "MALLOC" ou "malloc",
...
" ⚡ Impacto: Controle inteligente - flexível quando precisa, específico quando quer
...
set wildmenu
" 📖 TÓPICO: Menu visual para autocompletar comandos
...
" 💡 Exemplo prático: :setl<Tab> completa "setlocal" automático
...
"    e ocupam espaço. Para desenvolvimento, não são necessários
...
" ⚡ Impacto: Sempre trabalha com versão mais atual do arquivo
...
" 📚 Referência: :help autocmd, Intel Assembly conventions
...
" 📖 TÓPICO: Formato de comentários para C
" 🎯 Por que no OSR2: Plugins e comandos que adicionam comentários
...
"    4 espaços é padrão para shell scripts modernos
...
" ⚡ Impacto: CRÍTICO - Makefiles funcionam sem erros de sintaxe
...
" ⚡ Impacto: Tela limpa para continuar editando sem distrações
" 📚 Referência: :help :noh
...
" 🎯 Por que no OSR2: Comparando código/assembly, você usa splits.
...
" 🎯 Por que no OSR2: Compilação frequente é necessária. F9 é padrão
...
" 💡 Exemplo prático: Compilou kernel.c, F10 roda ./kernel
...
" 📖 TÓPICO: Flags de estado do arquivo
...
"    e posição/estatísticas (direita)
" 💡 Exemplo prático: arquivo.c [+]        │        C 75% 42/100
...
" 💡 Exemplo prático: 142/1850 = linha 142 de 1850 total
...
"    Folding é para usar quando precisar
...
- **💡 Exemplo prático:** Como usar na prática real
...
- `colorscheme default` - Funciona sempre (WSL, terminals diversos)
...
- **C files:** `tabstop=4 expandtab` - Código educativo legível (vs kernel=8)
...
**Contexto:** Arch Linux Minimal no WSL  
